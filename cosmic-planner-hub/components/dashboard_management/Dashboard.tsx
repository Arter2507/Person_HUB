...
// FIX: Import UserStatusBar component to resolve reference error.
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <StatCard icon={<Flame size={24} />} title="Streak" value="15 Days" colorClass="text-orange-400" />
                    <StatCard icon={<CheckCircle size={24} />} title="Tasks Completed" value="128" colorClass="text-green-400" />
                    <StatCard icon={<Star size={24} />} title="XP Points" value="1,500 XP" colorClass="text-yellow-400" />
                </div>
